...
public class CustomerContactRepositoryDbUnitTest {
    ...
    public void testFindByEmail() {
        ...
        Optional<CustomerContact> foundContact = customerContactRepository.findById(new Long(2));
        
        assertThat(foundContact.get().getEmail(), is(equalTo("elaine@myemail.com")));
    }
